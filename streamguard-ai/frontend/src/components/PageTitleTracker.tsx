...
const ROUTE_TITLES: Record<string, string> = {
  ...
  '/simulator': 'Fraud Attack Simulator & Live Playground | Flowshield AI',
  '/demo': 'Interactive Threat Simulator | Flowshield AI',
  '/dashboard/simulator': 'Attack Simulator | Defense Console | Flowshield AI',
