...
export default function Demo() {
  ...
  return (
    <div className="min-h-screen bg-[#050810] text-[#f8fafc] font-sans selection:bg-blue-500/30 overflow-hidden relative">
        ...
        <div className="flex-grow max-w-xl mx-12">
           <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-[#0f172a] border border-white/5 rounded-md py-1.5 pl-10 pr-4 text-xs font-medium text-slate-400 focus:outline-none" 
              />
           </div>
        </div>

        <div className="flex items-center gap-5">
           <div className="bg-[#1D4ED8] border border-blue-400/30 px-3 py-1 rounded-md flex items-center gap-2 shadow-lg shadow-blue-900/40">
      ...
      {/* 2. MAIN HUB Area */}
      <div className="absolute top-14 left-0 right-0 h-[300px] bg-gradient-to-b from-blue-600/5 to-transparent pointer-events-none" />
      ...
      <main className="max-w-7xl mx-auto px-8 py-20 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-10">
            ...
            {SCENARIOS.map((s) => (
              <button
                ...
                className={`w-full text-left p-6 rounded-2xl border transition-all duration-300 group ${
                  activeId === s.id 
                  ? 'bg-[#0f172a] border-[#2563eb]/40 shadow-2xl' 
                  : 'bg-[#0f172a]/20 border-white/5 hover:border-white/10'
                }`}
              >
                <div className="flex items-center justify-between">
                  ...
                  <ChevronRight className={`w-5 h-5 text-slate-800 group-hover:text-slate-400 transition-transform ${activeId === s.id ? 'translate-x-1 text-indigo-400' : ''}`} />
                </div>
              </button>
            ))}
          ...
          <div className="space-y-6">
            ...
            {/* CODE */}
            <div className="bg-[#020617] rounded-3xl border border-white/5 p-8 font-mono text-[14px] leading-relaxed">
               <div className="space-y-1">
                  <div className="mb-2">
                    <span className="text-[#f43f5e]">await</span> <span className="text-[#f8fafc]">flowshield.analyze(&#123;</span>
                  </div>
                  <div className="pl-6">
                    <span className="text-[#facc15]">transaction_id</span>: <span className="text-[#10b981]">"tx_high_value_foreign"</span>,
                  </div>
                  <div className="pl-6">
                    <span className="text-[#facc15]">amount</span>: <span className="text-[#facc15]">{active.values.amount}</span>,
                  </div>
                  <div className="pl-6">
                    <span className="text-[#facc15]">currency</span>: <span className="text-[#10b981]">"INR"</span>,
                  </div>
                  <div className="pl-6">
                    <span className="text-[#facc15]">channel</span>: <span className="text-[#10b981]">"web"</span>
                  </div>
                  <div className="mt-2">
            ...
            {/* DECISION CARD */}
            <div className="bg-[#0f172a] rounded-3xl border border-white/5 p-8 shadow-2xl relative">
               <div className="flex justify-between items-start mb-12">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-[44px] font-black">{active.values.score}<span className="text-[20px] text-slate-700 ml-0.5">%</span></div>
                  </div>
               </div>
               ...
               <div className="grid grid-cols-2 gap-4 mb-10">
                  <div className="bg-[#020617] border border-white/5 rounded-2xl p-4 flex flex-col gap-1">
                     ...
                     <div className="text-xl font-bold text-slate-200 uppercase">35ms</div>
                  </div>
                  <div className="bg-[#020610] border border-white/5 rounded-2xl p-4 flex flex-col gap-1">
                     <div className="text-[9px] font-bold text-slate-500 uppercase tracking-widest mb-1 flex items-center gap-2">
               ...
               {/* FORENSICS */}
               <div className="space-y-4">
                  <div className="text-[11px] font-bold text-indigo-400 uppercase tracking-[0.2em] flex items-center gap-2 mb-6">
                  ...
                  <AnimatePresence mode="wait">
                    <motion.div key={activeId} initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-3">
                      {active.forensics.map((f, i) => (
                        <div key={i} className="flex items-center gap-4 py-3.5 px-6 rounded-2xl bg-[#020610]/60 border border-white/5">
