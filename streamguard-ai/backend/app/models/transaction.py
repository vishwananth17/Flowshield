...
class Transaction(Base):
    ...
    upi_flow_type: Mapped[str | None] = mapped_column(String(50), nullable=True)
    ...
    is_cod: Mapped[bool | None] = mapped_column(Boolean, server_default="false", nullable=True)
    rto_risk_score: Mapped[int | None] = mapped_column(Integer, nullable=True)
